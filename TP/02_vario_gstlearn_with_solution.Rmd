...
# isotropic case
model_iso = model_fit(varioexp_iso,struct=struct_names,verbose=TRUE)
...
ot = Option_AutoFit()
ot$setMaxiter(50)
OptDbg_define(EDbg_CONVERGE())
modelVM = model_fit(grid.vmap,struct=struct_names,mauto=ot,verbose=TRUE)
modelVM$display()

# model fitted on the experimental variogram (4 directions)
modelexp = model_fit(varioexp_aniso,struct=struct_names,verbose=TRUE)
modelexp$display()
