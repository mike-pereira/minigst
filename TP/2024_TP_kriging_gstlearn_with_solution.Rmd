...
p1 = dbplot_grid(targetDb, color='OK.log_cadmium.estim',title='Unique Neigh. : Kriging predictions',colorLegendTitle = "",colValLimits = colValLimits)

## Plot of kriging predictions using unique moving neighborhood
p2 = dbplot_grid(targetDb, color='OK_mov.log_cadmium.estim',title='Mov. Neigh. : Kriging predictions',colorLegendTitle = "",colValLimits = colValLimits)
