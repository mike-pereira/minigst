...
bubblePlot(targetData$x, targetData$y, SKestim, asp=1,main="Simple kriging predictions")
...
bubblePlot(targetData$x, targetData$y, SKsd, asp=1,main="Simple kriging std-dev")
points(obsData$x,obsData$y,pch=19,cex=0.25)
...
p1=dbplot_grid(targetDb, color='SK_iso.log_cadmium.estim',
               title='Simple kriging: Predictions',colorLegendTitle = "")

## Plot kriging stdev
p2=dbplot_grid(targetDb, color='SK_iso.log_cadmium.stdev',
               title='Simple kriging: Std-dev',colorLegendTitle = "", cmap="RdBu")
...
p1=dbplot_grid(targetDb, color='SK.log_cadmium.estim',
               title='Simple kriging - Aniso: Predictions',colorLegendTitle = "")

## Plot the kriging stdev
p2=dbplot_grid(targetDb, color='SK.log_cadmium.stdev',
               title='Simple kriging - Aniso: Std-dev',colorLegendTitle = "", cmap="RdBu")
...
p1=dbplot_grid(targetDb, color='OK.log_cadmium.estim',
               title='Ordinary kriging: Predictions',colorLegendTitle = "")

## Plot kriging stdev
p2=dbplot_grid(targetDb, color='OK.log_cadmium.stdev',
               title='Ordinary kriging: Std-dev',colorLegendTitle = "", cmap="RdBu")
...
p1 = dbplot_grid(targetDb, color='OK_mov.log_cadmium.estim',
                 title='Mov. Neigh. : Kriging predictions',colorLegendTitle = "")

## Plot of kriging stdev
p2 = dbplot_grid(targetDb, color='OK_mov.log_cadmium.stdev',
                 title='Mov. Neigh. : Kriging std-dev',colorLegendTitle = "", cmap = "RdBu")
...
p1 = dbplot_grid(targetDb, color='OK.log_cadmium.estim',title='Unique Neigh. : Kriging predictions',
                 colorLegendTitle = "",colValLimits = colValLimits)

## Plot of kriging predictions using unique moving neighborhood
p2 = dbplot_grid(targetDb, color='OK_mov.log_cadmium.estim',title='Mov. Neigh. : Kriging predictions',
                 colorLegendTitle = "",colValLimits = colValLimits)
...
minixvalid(obsDb, vname = "log_cadmium", model=model_aniso, type = "ordinary", prefix="Xvalid_OK_mov", mean = mean_log_cadmium, neighborhood = "unique", std = TRUE)
```
...
## Plot ordinary kriging prediction and 
dbplot_point(obsDb,color = xvalid_name, cmap="viridis")
...
p1=dbplot_grid(targetDb,color = 'COK.log_cadmium.estim',
               title='Cokriging Log cadmium: Predictions',colorLegendTitle = "")
## Cokriging standard deviation of Cadmium
p2=dbplot_grid(targetDb,color = 'COK.log_cadmium.stdev',
               title='Cokriging Log cadmium: Std-dev',colorLegendTitle = "", cmap="RdBu")
## Plot side by side
ggarrange(p1,p2,nrow = 1)
```
...
p1=dbplot_grid(targetDb,color = 'COK.log_copper.estim',
               title='Cokriging Log copper: Predictions',colorLegendTitle = "")
## Cokriging standard deviation of copper
p2=dbplot_grid(targetDb,color = 'COK.log_copper.stdev',
               title='Cokriging Log copper: Std-dev',colorLegendTitle = "", cmap="RdBu")
## Plot side by side
ggarrange(p1,p2,nrow = 1)
...
p1=dbplot_grid(targetDb,color = 'COK.log_lead.estim',
               title='Cokriging Log lead: Predictions',colorLegendTitle = "")
## Cokriging standard deviation of lead
p2=dbplot_grid(targetDb,color = 'COK.log_lead.stdev',
               title='Cokriging Log lead: Std-dev',colorLegendTitle = "", cmap="RdBu")
## Plot side by side
ggarrange(p1,p2,nrow = 1)
...
p1=dbplot_grid(targetDb,color = 'COK.log_zinc.estim',
               title='Cokriging Log zinc: Predictions',colorLegendTitle = "")
## Cokriging standard deviation of zinc
p2=dbplot_grid(targetDb,color = 'COK.log_zinc.stdev',
               title='Cokriging Log zinc: Std-dev',colorLegendTitle = "", cmap="RdBu")
## Plot side by side
ggarrange(p1,p2,nrow = 1)
...
3. Compare ordinary kriging and cokriging results
