...
p1=dbplot_grid(target, color='UK.log_cadmium.estim',title='Universal Kriging: Pred.',colorLegendTitle = "Value")
## Plot kriging stdev
p2=dbplot_grid(target, color='UK.log_cadmium.stdev',title='Universal Kriging: Std-Dev',colorLegendTitle = "Value")
## Side by side plot
