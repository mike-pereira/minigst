...
def dbplot_point(db, color=None, size=None, cmap=None, size_range=(0.5, 3),
                 aspect=1, xlabel=None, ylabel=None, title=None, ax=None, **kwargs):
    """
...
def dbplot_grid(db_grid, color=None, cmap=None, aspect=1, 
                xlabel=None, ylabel=None, title=None, ax=None, **kwargs):
    """
    ...
    im = ax.imshow(data, origin='lower', extent=extent, cmap=cmap, 
                   aspect='auto' if aspect != 1 else 'equal', **kwargs)
